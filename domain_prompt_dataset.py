...
class PromptDataset(Dataset):
    ...
    def __getitem__(self, index):
        example = {}
        if self.placeholder_token == None:
            text = imagenet_templates_small[index % self.number_of_prompts]
            text = text.format(self.domain_token)
        else:
            text = imagenet_templates_all[index % self.number_of_prompts]
            text = text.format(self.domain_token,self.placeholder_token)
